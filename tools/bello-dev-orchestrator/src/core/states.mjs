...
const TRANSITIONS = Object.freeze({
  ...
  [STATES.DELIVERING]: [STATES.COMPLETED, STATES.AWAITING_USER, STATES.FAILED, STATES.CANCELLED],
  ...
  // A cooperative eco run owns a legacy task while it is paused. After the
  // independently tested staging run completes, the host reflects that
  // durable result into the legacy task as completed.
  [STATES.PAUSED]: [STATES.QUEUED, STATES.COMPLETED, STATES.CANCELLED, STATES.FAILED],
